...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        if (backPressedTime + 2000 > System.currentTimeMillis()){       // если время больше 2 секунд, то закрываем игу
            backToast.cancel();
            super.onBackPressed();
            return;
        }else {
        ...
        backPressedTime = System.currentTimeMillis();// засекли веремя нажатия на кнопку
    }
